...
import com.alibaba.rsqldb.clients.sql.DispatcherSqlStream;
...
public class SqlStreamBuilder {
    ...
    public static SqlStream sqlStream(String namespace) {
        return SqlStream.create(namespace);
    }
    ...
    public static DispatcherSqlStream dispatcherSqlStream(String namespace) {
        return DispatcherSqlStream.create(namespace);
    }

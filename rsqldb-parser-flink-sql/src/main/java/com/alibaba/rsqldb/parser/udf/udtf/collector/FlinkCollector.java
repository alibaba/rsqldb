...
public class FlinkCollector implements Collector {
    private FlinkRowCollector blinkRowCollector;
    private FlinkTupleCollector blinkTupleCollector = new FlinkTupleCollector();

    public FlinkCollector(FlinkUDTFScript target) {
        blinkRowCollector = new FlinkRowCollector(target);
    }

...
import com.alibaba.rsqldb.parser.udf.udaf.BlinkUDAFScript;
import com.alibaba.rsqldb.parser.udf.udf.BlinkUDFScript;
...
@ServiceName("blink")
public class BlinkUdfScan implements IUDFScan {
    @Override

...
public abstract class AbstractSqlBuilder implements ISqlNodeBuilder {
    ...
    public String createSQLFromParser() {
        ...
        if (fromSql != null) {
            sb.append(getFromSql()).append(PrintUtil.LINE);
        }
    ...
    public SqlBuilderResult buildSql() {
        ...
        if (getPipelineBuilder() == null) {
            pipelineBuilder = new PipelineBuilder(getNamespace(), getTableName(), this.configuration);
        }
    ...
    protected PipelineBuilder createPipelineBuilder() {
        PipelineBuilder pipelineBuilder = new PipelineBuilder(this.pipelineBuilder.getPipelineNameSpace(), this.pipelineBuilder.getPipelineName(), this.configuration);
        ...
        if (pipelineBuilder.getCurrentStageGroup() == null && pipelineBuilder.getParentStageGroup() == null) {
            ...
            if (pipelineBuilder.getParentStageGroup() != null) {
                ...
                if (isMergeGroup && parent != null) {
                    ...
                    children.getAllStageLabels().addAll(parent.getAllStageLabels());
                } else {
                    if (parent != null) {

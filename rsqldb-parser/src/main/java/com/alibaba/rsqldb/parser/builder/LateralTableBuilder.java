...
public class LateralTableBuilder extends SelectSqlBuilder {
    ...
    protected String lateralFunctionName;
    ...
    public SqlBuilderResult buildSql() {
        ...
        FunctionScript functionScript = new FunctionScript(scripts.get(0));
        functionScript.init();
        this.lateralFunctionName = functionScript.getScriptExpressions().get(0).getFunctionName();
        ScriptOperator scriptOperator = new ScriptOperator(scriptValue.toString());
        AbstractChainStage stage = getPipelineBuilder().addChainStage(scriptOperator);
        stage.setSql("LATERAL TABLE(" + lateralFunctionName + "(" + MapKeyUtil.createKeyFromCollection(",", fieldNames) + "))");
    ...
    public String getLateralFunctionName() {
        return lateralFunctionName;
    }

    public void setLateralFunctionName(String lateralFunctionName) {
        this.lateralFunctionName = lateralFunctionName;
    }
}

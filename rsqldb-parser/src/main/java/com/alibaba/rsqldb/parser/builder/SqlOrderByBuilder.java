...
public class SqlOrderByBuilder extends SelectSqlBuilder {
    ...
    public SqlBuilderResult buildSql() {
        ...
        Pair<AbstractChainStage, AbstractChainStage> pair = addWindowStage(subPipelineBuilder, shuffleOverWindow);

        SqlBuilderResult sqlBuilderResult = new SqlBuilderResult(subPipelineBuilder, pair.getLeft(), pair.getRight());
        mergeSQLBuilderResult(sqlBuilderResult);
    ...
    protected Pair<AbstractChainStage, AbstractChainStage> addWindowStage(PipelineBuilder subPipelineBuilder,
        AbstractWindow window) {
        AbstractChainStage windowStage = subPipelineBuilder.addChainStage(window);
        ...
        if (windowStage instanceof ShuffleChainStage) {
            subPipelineBuilder.getPipeline().getStages().remove(windowStage);
            ...
            subPipelineBuilder.addChainStage(firstStage);
            subPipelineBuilder.addChainStage(lastStage);
            subPipelineBuilder.setHorizontalStages(firstStage);
            subPipelineBuilder.setCurrentChainStage(lastStage);

        } else {
            subPipelineBuilder.setHorizontalStages(windowStage);
            subPipelineBuilder.setCurrentChainStage(windowStage);
        }

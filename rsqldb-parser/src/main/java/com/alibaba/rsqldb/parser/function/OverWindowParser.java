...
public class OverWindowParser extends AbstractSelectNodeParser<SqlBasicCall> {
    ...
    private static final Log LOGGER = LogFactory.getLog(SelectSqlBuilder.class);
    ...
    public IParseResult parse(SelectSqlBuilder builder, SqlBasicCall sqlBasicCall) {
        ...
        String rowNumberName = NameCreatorContext.get().createName("over", "parition");
        ...
        builder.setOverWindowBuilder(windowBuilder);

...
import com.alibaba.rsqldb.parser.result.NotSupportParseResult;
...
public class SQLNodeAsOperatorParser extends AbstractSelectNodeParser<SqlBasicCall> {

    private static final Log LOG = LogFactory.getLog(SQLNodeAsOperatorParser.class);
